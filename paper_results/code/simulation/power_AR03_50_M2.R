...
for (sp in c(0.04)) {
  ...
  if (sp == 0.04) {
    w = seq(4,7,length.out=10)
  } else if (sp == 0.2) {
    w = seq(1,4,length.out=10)
  } 
  ...
  fname <- paste0("/fs/project/PAS1149/qldeng/MTAFSC/results/data_plots/power_EJHG/ep2/power_ar03_50_M2_",sp,".rds")
