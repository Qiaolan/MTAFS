...
for (sp in c(0.02,0.2,0.5)) {
  ...
  if (sp == 0.02) {
    w = seq(0.5,1.4,length.out=10)
  } else if (sp == 0.2) {
    w = seq(0.5,1.1,length.out=10)
  } else if (sp == 0.5) {
    w = seq(0.5,1.1,length.out=10)
  }
  ...
  fname <- paste0("/fs/project/PAS1149/qldeng/MTAFSC/results/data_plots/power_EJHG/ep1/power_UKCOR2_M1_",sp,".rds")
