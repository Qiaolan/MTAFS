...
for (sp in c(0.02,0.2,0.5)) {
  print(sp)
  
  if (sp == 0.02) {
    w = seq(1.3,2.5,length.out=10)
  } else if (sp == 0.2) {
    w = seq(1.5,3,length.out=10)
  } else if (sp == 0.5) {
    w = seq(1,2,length.out=10)
  }
  ...
  fname <- paste0("/fs/project/PAS1149/qldeng/MTAFSC/results/data_plots/power_EJHG/ep2/power_UKCOR2_M2_",sp,".rds")
