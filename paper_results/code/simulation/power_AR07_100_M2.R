...
# T=50
#seq(4,7,length.out=10) 0.3 25:26
#seq(1,4,length.out=10) 0.3 20:30
#seq(2,6,length.out=10) 0.7 25:26
#seq(2,5,length.out=10) 0.7 20:30

# T=100
#seq(5,8,length.out=10) 0.3 50:51
#seq(1,2.5,length.out=10) 0.3 40:60
#seq(4,6.7,length.out=10) 0.7 50:51
#seq(2,3.5,length.out=10) 0.7 40:60




for (sp in c(0.02,0.2)) {
  print(sp)
  
  if (sp == 0.02) {
    w = seq(4,6.7,length.out=10)
  } else if (sp == 0.2) {
    w = seq(2,3.5,length.out=10)
  } 
  ...
  fname <- paste0("/fs/project/PAS1149/qldeng/MTAFSC/results/data_plots/power_EJHG/ep2/power_ar07_100_M2_",sp,".rds")
